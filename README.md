...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-psutil-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-psutil-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-psutil
# for installing globally
pixi global install types-psutil
```
...
It is possible to list all of the versions of `types-psutil` available on your platform:
...
```
pixi search types-psutil --channel conda-forge
```
